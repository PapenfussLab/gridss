...
public enum VcfAttributes {
	...
	ASSEMBLY_READPAIR_REMAPPED ("A_RPNS", 2, VCFHeaderLineType.Integer, "Count of read pair breakpoint evidence contributing to assembly but not independently supporting the breakpoint (Normal,Tumour)"),
	...
	ASSEMBLY_SOFTCLIP_REMAPPED ("A_SCNS", 2, VCFHeaderLineType.Integer, "Count of soft clipped breakpoint evidence contributing to assembly but not independently supporting the breakpoint (Normal,Tumour)"),
