...
public class ContigKmerCounterTest  extends TestHelper {
    ...
    public void should_count_at_end_of_read_and_reference() {
        ContigKmerCounter ckc = new ContigKmerCounter(ImmutableList.of("test1", "test2"), ImmutableList.of(B("AACCGGTTT"), B("A")), 4);
    ...
    public void should_ignore_duplicate_contigs() {
        ContigKmerCounter ckc = new ContigKmerCounter(ImmutableList.of("test1", "test2", "test1"), ImmutableList.of(B("AACCGGTTT"), B("A"), B("AAAAAAAAAAAAAAAAAA")), 3);
    ...
    public void should_not_double_count_repeated_kmers() {
        ContigKmerCounter ckc = new ContigKmerCounter(ImmutableList.of("test1", "test2"), ImmutableList.of(B("CCTCCTT"), B("A")), 3);
