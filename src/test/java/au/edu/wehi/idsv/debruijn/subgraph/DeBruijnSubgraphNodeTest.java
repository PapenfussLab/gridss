...
public class DeBruijnSubgraphNodeTest extends TestHelper {
	...
	public void should_track_bounds() {
		DeBruijnSubgraphNode r0 = new DeBruijnSubgraphNode(fsc, 0, new ReadKmer(0, 1, false));
		DeBruijnSubgraphNode r1 = new DeBruijnSubgraphNode(fsc, 0, new ReadKmer(0, 1, false));
		DeBruijnSubgraphNode r2 = new DeBruijnSubgraphNode(fsc, 0, new ReadKmer(0, 1, false));
