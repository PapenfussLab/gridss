...
/**
 * Orders according to startY, startX, endY, endX
 * @author cameron.d
 *
 */
public class TrapezoidGraphNodeStartYXComparator implements Comparator<TrapezoidGraphNode> {
	@Override
	public int compare(TrapezoidGraphNode o1, TrapezoidGraphNode o2) {
		int cmp = ComparatorUtil.compare(o1.startY, o2.startY);
