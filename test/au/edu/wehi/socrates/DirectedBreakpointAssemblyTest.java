...
public class DirectedBreakpointAssemblyTest extends TestHelper {
	...
	public void null_reference_should_result_in_N_ref_call() {
		assertEquals("N", DirectedBreakpointAssembly.create(new ProcessingContext(null, getSequenceDictionary(), null), "test", 0, 1, BreakpointDirection.Forward, B("A"), B("AA"), 1, 0).getReference().getDisplayString());
	}
	@Test
	public void should_lookup_reference_base() {
		assertEquals("A", DirectedBreakpointAssembly.create(getContext(), "test", 0, 1, BreakpointDirection.Forward, B("A"), B("AA"), 1, 0).getReference().getDisplayString());
	}
	@Test
	public void anchor_should_use_reference_base_not_assembly_base() {
		String alt = DirectedBreakpointAssembly.create(getContext(), "test", 0, 1, BreakpointDirection.Forward, B("A"), B("CC"), 1, 0).getAlternateAllele(0).getDisplayString();
		assertEquals('A', alt.charAt(0));
	}
	@Test
	public void should_round_trip_AssemblerProgram() {
		DirectedBreakpointAssembly dba = DirectedBreakpointAssembly.create(getContext(), "test", 0, 1, BreakpointDirection.Forward, B("A"), B("AA"), 1, 0);
	...
	public void should_round_trip_getAssemblyReadCount() {
		DirectedBreakpointAssembly dba = DirectedBreakpointAssembly.create(getContext(), "test", 0, 1, BreakpointDirection.Forward, B("A"), B("AA"), 7, 0);
	...
	public void should_match_variant_location_f() {
		DirectedBreakpointAssembly dba = DirectedBreakpointAssembly.create(getContext(), "test", 0, 10, BreakpointDirection.Forward, B("AT"), B("ATA"), 1, 0);
		dba = new DirectedBreakpointAssembly(getContext(), new VariantContextBuilder(dba).make());
	...
	public void should_match_variant_location_b() {
		DirectedBreakpointAssembly dba = DirectedBreakpointAssembly.create(getContext(), "test", 0, 10, BreakpointDirection.Backward, B("AT"), B("ATA"), 1, 0);
		dba = new DirectedBreakpointAssembly(getContext(), new VariantContextBuilder(dba).make());
		assertEquals("polyA", dba.getChr());
		assertEquals(10, dba.getStart());
		assertEquals(10, dba.getEnd());
	...
	public void phred_should_be_breakpoint_quality() {
		DirectedBreakpointAssembly dba = DirectedBreakpointAssembly.create(getContext(), "test", 0, 10, BreakpointDirection.Backward, B("AT"), B("ATA"), 1, 7);
		dba = new DirectedBreakpointAssembly(getContext(), new VariantContextBuilder(dba).make());
		assertEquals(7, dba.getPhredScaledQual(), 0);
	}
	@Test
	public void should_generate_single_breakend_f() {
		DirectedBreakpointAssembly dba = DirectedBreakpointAssembly.create(getContext(), "test", 0, 1, BreakpointDirection.Forward, B("AT"), B("ATA"), 1, 0);
		// ref base + breakpoint
	...
	public void should_generate_single_breakend_b() {
		// ref base + breakpoint
		DirectedBreakpointAssembly dba = DirectedBreakpointAssembly.create(getContext(), "test", 0, 1, BreakpointDirection.Backward, B("AT"), B("ATA"), 1, 0);
	...
	public DirectedBreakpointAssembly test_mated_breakend(BreakpointDirection direction, boolean realignPositive, String bpString, String realignedCigar, String expectedAllele) {
	...
	public void should_create_mated_breakend_if_realigned_ff() {
		...
		//        .SMMMSS
		//         CATCAT
		test_mated_breakend(BreakpointDirection.Forward, true, "CGTCGT", "1S3M2S", "AC[polyACGT:10[");
	}
	@Test
	public void should_create_mated_breakend_if_realigned_fb() {
		...
		//         SMMMSS.
		//         ATGATG
		test_mated_breakend(BreakpointDirection.Forward, false, "CGTCGT", "1S3M2S", "ACG]polyACGT:12]");
	}
	@Test
	public void should_create_mated_breakend_if_realigned_bf() {
		...
		//         SMMMSS.
		//         CATCAT
		test_mated_breakend(BreakpointDirection.Backward, true, "CGTCGT", "1S3M2S", "]polyACGT:12]GTA");
	}
	@Test
	public void should_create_mated_breakend_if_realigned_bb() {
		...
		//        .SMMMSS
		//         ATGATG
		test_mated_breakend(BreakpointDirection.Backward, false, "CGTCGT", "1S3M2S", "[polyACGT:10[TA");
	}
	@Test
	public void should_be_vcf_sv_breakend() {
		assertEquals("BND", DirectedBreakpointAssembly.create(getContext(), "test", 0, 1, BreakpointDirection.Forward, B("A"), B("AA"), 1, 0)
